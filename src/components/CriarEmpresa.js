import {
  ...
  Button,
  FormControl,
  FormHelperText, IconButton, InputLabel,
  Modal,
  OutlinedInput,
  Typography
  ...
  return (
    <Modal open={open} onClose={onCloseModal}>
      <Box
        ...
        height="100%"
      >
        <Box bgcolor="white" borderRadius={5} maxWidth={800} maxHeight={600} width="100%">
          <Box className={classes.modalHeader}>
            <Typography variant="h4">{editingCompany ? `Editar:${name}` : "Adicionar Empresa"}</Typography>
